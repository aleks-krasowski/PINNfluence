...
apptainer run --nv --bind ${LOCAL_JOB_DIR}:/opt/model_zoo --bind ${HOME}/pinnfluence_finetuning/pinnfluence:/opt/code ./deepxde_generic_code.sif  /opt/code/burgers/pretrain_model.py 
